...
require (
	...
	git.basebit.me/enigma/sqlfs-go v0.0.3-0.20210318012258-a47c010ef35d
	git.basebit.me/enigma/xkube-common v0.0.5
...
replace (
	...
	git.basebit.me/enigma/xkube-common => git.basebit.me/enigma/xkube-common v0.0.5
