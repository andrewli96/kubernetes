...
require (
	...
	git.basebit.me/enigma/sqlfs-go v0.0.1
...
replace (
	...
	git.basebit.me/enigma/sqlfs-go => git.basebit.me/enigma/sqlfs-go v0.0.1
	git.basebit.me/enigma/xkube-common => git.basebit.me/enigma/xkube-common v0.0.3
